...
describe('PseudoQueue', () => {
  ...
  it('Enqueue enqueues with empty rear stack', () => {
  ...
  it('Enqueue enqueues with existing rear stack', () => {
  ...
  it('Dequeue dequeues with empty stacks', () => {
  ...
  it('Dequeue dequeues with empty front', () => {
  ...
  it('Dequeue dequeues with existing rear and front stack', () => {
